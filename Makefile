#Makefile by Ketor 
CC        = gcc -DHAVE_STRUCT_TIMESPEC -D__USE_FILE_OFFSET64 -DHAVE_CONFIG_H -I. -D__CEPH__ -D_FILE_OFFSET_BITS=64 -D_REENTRANT -D_THREAD_SAFE -D__STDC_FORMAT_MACROS -D_GNU_SOURCE -fno-strict-aliasing -fsigned-char -fno-builtin-malloc -fno-builtin-calloc -fno-builtin-realloc -fno-builtin-free -g -DPIC 
CPP       = g++ -DHAVE_STRUCT_TIMESPEC -D__USE_FILE_OFFSET64 -DHAVE_CONFIG_H -I. -D__CEPH__ -D_FILE_OFFSET_BITS=64 -D_REENTRANT -D_THREAD_SAFE -D__STDC_FORMAT_MACROS -D_GNU_SOURCE -fno-strict-aliasing -fsigned-char -Wno-invalid-offsetof -fno-builtin-malloc -fno-builtin-calloc -fno-builtin-realloc -fno-builtin-free -g -DPIC 

BOOST_PATH=./ext_components/boost_1_60_0
BOOST_LIB_PATH=$(BOOST_PATH)/stage/lib
BOOST_SYSTEM_LIB=boost_system-mgw49-mt-1_60
CEPH_INCLUDE = -I./ -I./global -I./mingw_include -I$(BOOST_PATH)
CFLAGS   = $(CEPH_INCLUDE)
CLIBS    = -l$(BOOST_SYSTEM_LIB)
